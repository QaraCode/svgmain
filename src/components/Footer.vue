<template>
    ...
    <div class="main_footer">
        ...
        <div class="content_f">
            <h1 style="color: snow; padding: 25px">SVG Q19</h1>
        </div>
        <div class="content_q">
            <b style="color: snow; margin-left: 28px">Social Media</b>
            <div class="social">
                <div class="facebook"
                     style="   display: flex; align-items: center; justify-content: center; width: 25px; height: 25px; background-color: snow; border-radius: 6px">
                ...
                <div class="facebook" style="   display: flex; align-items: center; justify-content: center; width: 25px; height: 25px; background-color: snow; border-radius: 6px">
...
.main_footer {
    ...
    background: linear-gradient(90deg, rgba(2, 0, 36, 1) 0%, rgba(43, 43, 116, 1) 100%, rgba(0, 212, 255, 1) 100%);
